...
import org.apache.skywalking.apm.plugin.play.v2x.define.Play2xFilterInstrumentation;
 ...
 * 2019-08-15
 */
public class Play2XFilterInstrumentationTest {

    @Test
    public void testConstructorMatch() throws Exception {
        final ElementMatcher<MethodDescription> matcher = Play2xFilterInstrumentation.getInjectConstructorMatcher();
    ...
    public void testMethodMatch() throws Exception {
        final ElementMatcher<MethodDescription> matcher = Play2xFilterInstrumentation.getFiltersMethodMatcher();
