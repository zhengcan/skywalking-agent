 ...
 * 2019-08-01
 */
public class Play2xFilterInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
        ...
        return new ConstructorInterceptPoint[]{
            new ConstructorInterceptPoint() {
                ...
                public ElementMatcher<MethodDescription> getConstructorMatcher() {
                    return Play2xFilterInstrumentation.getInjectConstructorMatcher();
                }
        ...
        return new InstanceMethodsInterceptPoint[]{
            new InstanceMethodsInterceptPoint() {
                ...
                public ElementMatcher<MethodDescription> getMethodsMatcher() {
                    return Play2xFilterInstrumentation.getFiltersMethodMatcher();
                }
